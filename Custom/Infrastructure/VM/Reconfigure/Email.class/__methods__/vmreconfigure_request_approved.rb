...
# Get more details for the email
approver = miq_request.v_approved_by
approver_reason = miq_request.reason
...
body += "<br>Your Virtual Machine VM Reconfiguration request was approved by #{approver}."
body += "<br>Reason: #{approver_reason}."
